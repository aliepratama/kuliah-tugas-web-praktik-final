...
export default {
  ...
  data() {
    return {
      sectionData: [
        {
          id: 'brief',
          heading: 'Buat brief desain otomatis!',
        ...
        {
          id: 'rater',
          heading: 'Ketahui skor desain anda!',
  ...
  mounted(){
    this.$store.commit('changeRoute', { route: 'home' });
  },
}
</script>
...
<template>
  <div>
    <Header></Header>
    <SectionLP v-for="section in sectionData" :key="section.id" :data="section"/>
    <Footer></Footer>
  </div>
</template>
